...
${OBJ_DIR}/Vgstmcu.cpp: gstmcu.v clockgen.v hsyncgen.v hdegen.v vsyncgen.v vdegen.v modules.v
	verilator --trace --top-module gstmcu -cc gstmcu.v clockgen.v hdegen.v hsyncgen.v vsyncgen.v vdegen.v modules.v
