...
${OBJ_DIR}/Vgstmcu.cpp: gstmcu.v hsyncgen.v hdegen.v vsyncgen.v vdegen.v modules.v
	verilator --trace --top-module gstmcu -cc gstmcu.v hdegen.v hsyncgen.v vsyncgen.v vdegen.v modules.v
