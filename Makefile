...
${OBJ_DIR}/Vgstmcu.cpp: gstmcu.v clockgen.v mcucontrol.v hsyncgen.v hdegen.v vsyncgen.v vdegen.v vidcnt.v sndcnt.v latch.v register.v modules.v
	verilator --trace --top-module gstmcu -cc gstmcu.v clockgen.v mcucontrol.v hdegen.v hsyncgen.v vsyncgen.v vdegen.v vidcnt.v sndcnt.v latch.v register.v modules.v
